...
<div id="container">
		<ul class="tab">
			<li class='tabmenu' id="default" style="background-color : white; border : 1px solid lightgrey"><a href="<%=request.getContextPath() %>/notification/list.do">공고목록</a></li>
			...
			<div class="card-header with-border">
				<div class="row">
					...
					<div style="margin-left : auto">						
						<button type="button" class="btn btn-primary" id="registBtn" style="background-color: #215287; border-color: #215287;" onclick="OpenWindow('<%=request.getContextPath() %>/myproject/registForm.do','프로젝트등록',800,700);">프로젝트등록</button>				
						<button type="button" class="btn btn-primary" id="registBtn" style="background-color: #215287; border-color: #215287;" onclick="OpenWindow('registForm.do','공지등록',800,700);">공고등록</button>				
					</div>
				</div>
...
<!-- 						<th style="width:10%;">마감일자</th> -->
				  ...
				  <tbody>			
					...
					<c:forEach items="${recruitList }" var="recruit" varStatus="status">
						<tr style='font-size:0.85em;cursor:pointer;' onclick="OpenWindow('<%=request.getContextPath() %>/notification/detail.do?pblanc_sn=${recruit.pblanc_sn }&from=list','공고상세보기',800,740);">
