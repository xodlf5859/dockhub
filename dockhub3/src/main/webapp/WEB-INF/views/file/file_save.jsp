   	...
   	<div class="container-fluid">
 		<div class="row" style="padding : 5px;">
 			<div class="col-sm-3 card card-info" >
				...
				<div id="tree" style="padding: 10px; min-height : 83vh"> </div> 			
		  		<c:if test="${author eq 0}">
			  		<div id="author" style=" height : 30px; background-color: #10316b; text-align :center; border-radius : 10px">
			  
				  		<a href="javascript:OpenWindow('<%=request.getContextPath() %>/filesave/fileAuthor?prjct_sn='+${project.prjct_sn },'파일보관함',400,500);" style="color : white; " role="button">
				  		파일 권한 수정
				  		</a>
			...
			<div class="col-sm-9" >
				...
				<div class="card-body" style="padding: 30px; min-height : 89vh">
					<div class="row">
					<div style="font-size : 1.3em; display : inline">${project.prjct_sj }</div><div id="fileName" style="display : inline; font-size : 1.3em"></div>					
					</div>
					...
					<div style=" width : 120px; float : left;">
						<form id="ajaxForm" method="post" enctype="multipart/form-data">
					   		<button type="button" class="btn btn-block btn-primary" style="background-color : #10316b; width :110px; border : 0px;" onClick="ajaxFileUpload();">업로드</button>
							
								 <input type="file" name='uploadFile' id='uploadFile' onChange="ajaxFileChange();" style="display:none; " multiple/><br/>
						<!-- 		단위업무 : <input type='text' name="unit_job_sn" id="unit_job_sn"/><br/> -->
							<input type="hidden" id="nodeId" name="nodeId" value="">
							<input type="hidden" id="parent" name="parent" value="">
							<input type="hidden" id="author" name="parent" value="${author }">
					...
					<div style=" float : left;">
						<button type="button" class="btn btn-block btn-primary" id='deleteFile' name='deleteFile' style="background-color : #10316b; width :110px; border : 0px;  margin-right : 10px" onClick="deleteFile();">삭제하기</button>
					</div>
					</div>
