...
<!--            <div class="row md-2"> -->
<!--               <div class="col-sm-6"> -->
<!--                  <h1 style="margin-left: 87px;">이슈 등록</h1>               -->
<!--               </div> -->
<!--            </div> -->
<!--         </div> -->
<!--    </section> -->
		...
		<div class="col-md-9"   >
			...
			<div class="card card-outline card-info" style="border-top: 3px solid #282c2f;" >
				...
				<div class="card-header">
					<h3 class="card-title p-1">이슈 등록</h3>
				<!-- end header -->
				</div>
				<!-- start card body -->
				<div class="card-body pad">
					<form role="form" method="post" action="issueRegist.do?prjct_sn=${prjct_sn }" name="registForm">
						...
						<div class="form-group">
							...
							<input id="mile_no" name="mile_no" type="hidden" value="${mile_no }">
							<input id="mile_title" name="mile_title" class="form-control" readonly="readonly" value="${mile_title}"  style="margin-left: 100px;	margin-top: -37px; width: 81%;">   	                            
                       	</div>
						<div class="form-group">
