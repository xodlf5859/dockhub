...
<style type="text/css">
	#chatArea {
		...
		padding: 5px;   width : 430px; height : auto;
		margin: 0px auto;
	}
	#connectArea {
...
<body>
<input type="hidden" name="mber_ncnm" id="mber_ncnm" value="${member.mber_ncnm }"/>
	<div id="">
		<table>
		<tr>
			<td style="vertical-align: top;">
				<div id="chatArea">
				    <!-- 메시지 표시 영역 -->
				    <textarea id="messageTextArea" readonly="readonly" style="height: 832px;"></textarea><br><br>
				    <!-- 송신 메시지 텍스트박스 -->
				    <input type="text" id="messageText" size="30" onkeydown="JavaScrpit:Enter_Check();">  
				    <!-- 송신 버튼 -->
	    ...
	    <div id="connectArea">
		    ...
		    <!-- 접속 버튼 -->
		    <input type="button" id="connect" value="접속하기" onclick="connectting()">
	    </div>
    </div>
    ...
    <script type="text/javascript">
    	...
    	function connectting(){
    		if(userText.value.trim()==""){
				...
				//웹소켓 초기화
				webSocket = new WebSocket("ws://192.168.45.49/ddit/websocktGroupMultiChat.do");
